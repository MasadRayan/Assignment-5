document.getElementById("dark-mode-btn").addEventListener("click", function (event) {
    ...
    const fiestTitle = document.getElementById("title-2").innerText;
    ...
    document.getElementById("dark-mode-btn").disabled = true;
    document.getElementById("dark-mode-btn").style.backgroundColor = "lightgray"
})