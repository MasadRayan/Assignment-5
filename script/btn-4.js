document.getElementById("new-emoji-btn").addEventListener("click", function (event) {
    ...
    const fiestTitle = document.getElementById("title-4").innerText;
    ...
    document.getElementById("new-emoji-btn").disabled = true;
    document.getElementById("new-emoji-btn").style.backgroundColor = "lightgray"
})